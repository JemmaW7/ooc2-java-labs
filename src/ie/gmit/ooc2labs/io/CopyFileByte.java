...
public class CopyFileByte {
	public static void main(String args[]) throws IOException {
		...
		// Create int to read and write bytes. Read method returns an int - https://www.oreilly.com/library/view/java-io/1565924851/ch03s02.html
		int b = 0; 
...
//			System.out.println("-------------------");
			// Read in bytes. NOTE: If no byte is available because the end of the stream has been reached, the returned value is -1.
